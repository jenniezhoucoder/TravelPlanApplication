    ...
    return (
        <div className='privacy_page'>
          <div className="privacy_content">
            ...
            <h5>Last updated: April 27, 2022</h5>
            <p>This privacy notice for Junni Notion ("Company," "we," "us," or "our"), describes how and why we might collect, 
                store, use, and/or share ("process") your information when you use our services ("Services") such as when you:</p>

            <p>- Visit our website, or any website of ours that links to this privacy notice</p>
            <p>- Download and use our mobile application, or any other application of ours that links to this privacy
            notice</p>
            ...
            have any questions or concerns, please contact us at zhou.junn@northeastern.edu</p>
          ...
          <h2>SUMMARY OF KEY POINTS</h2>
            ...
            <p>This summary provides key points from our privacy notice, but you can find out more details
                ...
                contents below to find the section you are looking for. You can also click here to go directly to
                our table of contents.
            </p>

            <p>What personal information do we process? When you visit, use, or navigate our Services, we may
            process personal information depending on how you interact with Junni Notion and the Services, the
            ...
            <p>
            Do you receive any information from third parties? We do not receive any information from third
            parties.
            </p>
            <p>
            ...
            <ul>
                ...
                <li>
                    ...
                    interest, such as to prevent harm.</p>
                </li>

                <li>
                    <p><strong>3. WHAT LEGAL BASES DO WE RELY ON TO PROCESS YOUR PERSONAL INFORMATION?</strong></p>
                    <p>
                    ...
                    you with services to enter into or fulfill our contractual obligations, to protect your rights, or to fulfill our legitimate
                    business interests.
                ...
                <li>
                    ...
                    In some regions (like the EA, UK, and Canada), you have certain
                    rights under applicable data protection laws. These may include the
                    right (i) to request access and obtain a copy of your personal
                    information, (ii) to request rectification or erasure; (ili) to restrict the
                ...
                <li>
                    ...
                    <p>
                        If you have questions or comments about this notice, you may email us at zhou.junn@northeastern.edu.
                    </p>
                </li>
                <li>
